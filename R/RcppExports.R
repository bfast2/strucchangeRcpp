...
.sc_cpp_rssi <- function(y, X, n, i, intercept_only, tol, rcond_min) {
    .Call('strucchange_sc_cpp_rssi', PACKAGE = 'strucchange', y, X, n, i, intercept_only, tol, rcond_min)
}
...
.sc_cpp_construct_rss_table <- function(y, X, n, h, breaks, intercept_only, tol, rcond_min) {
    .Call('strucchange_sc_cpp_construct_rss_table', PACKAGE = 'strucchange', y, X, n, h, breaks, intercept_only, tol, rcond_min)
}
...
.sc_cpp_recresid <- function(X, y, start, end, tol, rcond_min) {
    .Call('strucchange_sc_cpp_recresid', PACKAGE = 'strucchange', X, y, start, end, tol, rcond_min)
}
