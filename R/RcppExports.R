...
.sc_cpp_rssi <- function(y, X, n, i, intercept_only, tol, rcond_min) {
    .Call('_strucchange_sc_cpp_rssi', PACKAGE = 'strucchange', y, X, n, i, intercept_only, tol, rcond_min)
}

.sc_cpp_rss <- function(rss_triang, i, j) {
    .Call('_strucchange_sc_cpp_rss', PACKAGE = 'strucchange', rss_triang, i, j)
}

.sc_cpp_extend_rss_table <- function(rss_table, rss_triang, n, h, breaks) {
    .Call('_strucchange_sc_cpp_extend_rss_table', PACKAGE = 'strucchange', rss_table, rss_triang, n, h, breaks)
}
...
.sc_cpp_construct_rss_table <- function(y, X, n, h, breaks, intercept_only, tol, rcond_min) {
    .Call('_strucchange_sc_cpp_construct_rss_table', PACKAGE = 'strucchange', y, X, n, h, breaks, intercept_only, tol, rcond_min)
}
...
.sc_cpp_efp_process_me <- function(X, y, rescale, h) {
    .Call('_strucchange_sc_cpp_efp_process_me', PACKAGE = 'strucchange', X, y, rescale, h)
}
...
.sc_cpp_efp_process_re <- function(X, y, rescale) {
    .Call('_strucchange_sc_cpp_efp_process_re', PACKAGE = 'strucchange', X, y, rescale)
}
...
.sc_cpp_fstats <- function(X, y, istart, iend, rcond_min) {
    .Call('_strucchange_sc_cpp_fstats', PACKAGE = 'strucchange', X, y, istart, iend, rcond_min)
}
...
.sc_cpp_recresid <- function(X, y, start, end, tol, rcond_min) {
    .Call('_strucchange_sc_cpp_recresid', PACKAGE = 'strucchange', X, y, start, end, tol, rcond_min)
}
...
.sc_cpp_rootmatrix <- function(X) {
    .Call('_strucchange_sc_cpp_rootmatrix', PACKAGE = 'strucchange', X)
}
...
.sc_cpp_rootmatrix_cross <- function(X) {
    .Call('_strucchange_sc_cpp_rootmatrix_cross', PACKAGE = 'strucchange', X)
}
