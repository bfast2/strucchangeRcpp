...
.sc_cpp_rssi <- function(y, X, n, i, intercept_only, tol) {
    .Call('strucchange_sc_cpp_rssi', PACKAGE = 'strucchange', y, X, n, i, intercept_only, tol)
}

.sc_cpp_rss <- function(rss_triang, i, j) {
    .Call('strucchange_sc_cpp_rss', PACKAGE = 'strucchange', rss_triang, i, j)
}

.sc_cpp_extend_rss_table <- function(rss_table, rss_triang, n, h, breaks) {
    .Call('strucchange_sc_cpp_extend_rss_table', PACKAGE = 'strucchange', rss_table, rss_triang, n, h, breaks)
}
...
#' @param 
#' @return 
.sc_cpp_construct_rss_table <- function(y, X, n, h, breaks, intercept_only, tol) {
    .Call('strucchange_sc_cpp_construct_rss_table', PACKAGE = 'strucchange', y, X, n, h, breaks, intercept_only, tol)
}
